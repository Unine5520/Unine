...
const shareIcon = `
  ...
  >
    <path
      d="M18 8
         C19.6569 8 21 6.65685 21 5
         C21 3.34315 19.6569 2 18 2
         C16.3431 2 15 3.34315 15 5
         C15 5.18351 15.0165 5.36317 15.0478 5.53735
         L8.392 9.199
         C7.864 8.455 7.001 8 6 8
         C4.34315 8 3 9.34315 3 11
         C3 12.6569 4.34315 14 6 14
         C7.001 14 7.864 13.545 8.392 12.801
         L15.0478 16.463
         C15.0165 16.6368 15 16.8165 15 17
         C15 18.6569 16.3431 20 18 20
         C19.6569 20 21 18.6569 21 17
         C21 15.3431 19.6569 14 18 14
         C17.0316 14 16.1934 14.427 15.6581 15.128
         L9.017 11.474
         C9.039 11.319 9.050 11.160 9.050 11
         C9.050 10.840 9.039 10.681 9.017 10.526
         L15.6581 6.872
         C16.1934 7.573 17.0316 8 18 8
         Z"
    />
  </svg>
`;
  ...
  >
    <path
      d="M18 8
         ...
         C17.0316 14 16.1934 14.427 15.6581 15.128
         L9.017 11.474
         C9.039 11.319 9.050 11.160 9.017 10.526
         L15.6581 6.872
         C16.1934 7.573 17.0316 8 18 8
         Z"
    />
